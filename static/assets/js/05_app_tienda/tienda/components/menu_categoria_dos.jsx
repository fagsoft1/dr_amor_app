...
import ProductoMenu from './menu_productos';
...
class CategoriaDosMenu extends Component {
    render() {
        const {categoria_dos, onBack, classes, onClick, categoria_dos_seleccionada, mostrar, adicionarItemAPedidoActual} = this.props;
        if (mostrar) {
            return (
