...
class List extends Component {
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        cargando();
        this.props.fetchPuntoVenta(item_id, success_method, notificarErrorAjaxAction);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.createPuntoVenta(item, success_method, notificarErrorAjaxAction);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.updatePuntoVenta(item.id, item, success_method, notificarErrorAjaxAction);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.deletePuntoVenta(item.id, success_method, notificarErrorAjaxAction);
    }
