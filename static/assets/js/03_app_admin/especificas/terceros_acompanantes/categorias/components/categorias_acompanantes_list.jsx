...
class List extends Component {
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        this.props.fetchCategoriaAcompanante(item_id, success_method);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        this.props.createCategoriaAcompanante(item, success_method);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        this.props.updateCategoriaAcompanante(item.id, item, success_method);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        this.props.deleteCategoriaAcompanante(item.id, success_method);
    }
