...
class List extends Component {
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        this.props.fetchCategoriaAcompanante(item_id, success_method, notificarErrorAjaxAction);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        this.props.createCategoriaAcompanante(item, success_method, notificarErrorAjaxAction);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        this.props.updateCategoriaAcompanante(item.id, item, success_method, notificarErrorAjaxAction);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        this.props.deleteCategoriaAcompanante(item.id, success_method, notificarErrorAjaxAction);
    }
