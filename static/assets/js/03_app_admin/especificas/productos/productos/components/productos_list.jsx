...
class List extends Component {
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        cargando();
        this.props.fetchProducto(item_id, success_method, notificarErrorAjaxAction);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.createProducto(item, success_method, notificarErrorAjaxAction);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.updateProducto(item.id, item, success_method, notificarErrorAjaxAction);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.deleteProducto(item.id, success_method, notificarErrorAjaxAction);
    }
