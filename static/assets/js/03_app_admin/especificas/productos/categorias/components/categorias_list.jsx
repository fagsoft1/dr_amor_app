...
class List extends Component {
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        this.props.fetchCategoriaProducto(item_id, success_method);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        this.props.createCategoriaProducto(item, success_method);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        this.props.updateCategoriaProducto(item.id, item, success_method);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        this.props.deleteCategoriaProducto(item.id, success_method);
    }
