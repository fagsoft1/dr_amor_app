...
class List extends Component {
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        cargando();
        this.props.fetchCategoriaProductoDos(item_id, success_method, notificarErrorAjaxAction);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.createCategoriaProductoDos(item, success_method, notificarErrorAjaxAction);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.updateCategoriaProductoDos(item.id, item, success_method, notificarErrorAjaxAction);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.deleteCategoriaProductoDos(item.id, success_method, notificarErrorAjaxAction);
    }
