...
class List extends Component {
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        this.props.fetchBodega(item_id, success_method, notificarErrorAjaxAction);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        this.props.createBodega(item, success_method, notificarErrorAjaxAction);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        this.props.updateBodega(item.id, item, success_method, notificarErrorAjaxAction);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        this.props.deleteBodega(item.id, success_method, notificarErrorAjaxAction);
    }
