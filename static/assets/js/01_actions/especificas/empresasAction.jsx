...
export const createEmpresa = (values, callback = null, callback_error = null) => {
    return (dispatch) => {
...
export const fetchEmpresas = (callback = null, callback_error = null) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const updateEmpresa = (id, values, callback = null, callback_error = null) => {
    return (dispatch) => {
        const dispatches = (response) => {
