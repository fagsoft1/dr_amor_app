import {CUENTA_CONTABLE_TYPES as TYPES} from '../../../00_types';
import {
    fetchListGet,
    updateObject,
    fetchObject,
...
const current_url_api = 'contabilidad_cuentas_contables';
export const createCuentaContable = (values, options_action = {}) => {
    return (dispatch) => {
...
export const deleteCuentaContable = (id, options_action = {}) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const fetchCuentasContables = (options_action = {}) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const clearCuentasContables = (options_action = {}) => {
    return (dispatch) => {
        dispatch({type: TYPES.clear, payload: options_action});

    }
};
export const updateCuentaContable = (id, values, options_action = {}) => {
    return (dispatch) => {
        const dispatches = (response) => {
