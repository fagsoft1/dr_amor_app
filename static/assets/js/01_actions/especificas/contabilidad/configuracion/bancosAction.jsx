import {BANCO_TYPES as TYPES} from '../../../00_types';
import {
    fetchListGet,
    updateObject,
    fetchObject,
...
const current_url_api = 'contabilidad_bancos_banco';
...
export const deleteBanco = (id, options_action = {}) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const clearBancos = (options_action = {}) => {
    return (dispatch) => {
