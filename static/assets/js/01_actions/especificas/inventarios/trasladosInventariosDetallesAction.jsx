...
export const fetchTrasladosInventariosDetallesxTralado = (traslado_id, callback = null, callback_error = null, limpiar_coleccion = true) => {
    return (dispatch) => {
        ...
        fetchListGetURLParameters(`${current_url_api}/por_traslado/?traslado_id=${traslado_id}`, dispatches, callback, callback_error, dispatch, limpiar_coleccion ? TYPES.clear : null);
    }
};
