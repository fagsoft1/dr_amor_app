...
export const createCategoriaProducto = (values, callback = null, callback_error = null) => {
    return (dispatch) => {
...
export const deleteCategoriaProducto = (id, callback = null, callback_error = null) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const updateCategoriaProducto = (id, values, callback = null, callback_error = null) => {
    return (dispatch) => {
        const dispatches = (response) => {
