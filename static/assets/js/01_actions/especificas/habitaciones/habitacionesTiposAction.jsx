...
export const createTipoHabitacion = (values, callback = null, callback_error = null) => {
    return (dispatch) => {
...
export const fetchTiposHabitaciones = (callback = null, callback_error = null) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const updateTipoHabitacion = (id, values, callback = null, callback_error = null) => {
    return (dispatch) => {
        const dispatches = (response) => {
