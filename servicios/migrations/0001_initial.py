    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor_servicio', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ('valor_habitacion', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ('valor_iva_habitacion', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ...
                ('transacciones_caja', models.ManyToManyField(related_name='transacciones_caja', to='cajas.TransaccionCaja')),
            ],
            options={
                'abstract': False,
            },
